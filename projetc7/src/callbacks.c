...
if  (   (     (	     ( strcmp (r.type,"Restauration") == 0 ) &&((strcmp (r.choix,"plats'ou'desserts") == 0 ) || (strcmp (r.choix,"autres") == 0 ))) || (( strcmp (r.type,"Hebergement") == 0 ) &&((strcmp (r.choix,"binome'ou'voisins") == 0 ) || (strcmp (r.choix,"binome'ou'voisins") == 0 )|| (strcmp (r.choix,"autres")==0)))) && (strcmp (r.d.h,"8h==>17h") == 0 ))
{
...
char pass[50];
int test21;
GtkWidget *input1,*input2,*hb_menu_employe,*output,*hb_login,*pInfo;
